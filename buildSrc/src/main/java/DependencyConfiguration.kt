...
object Dependency {
    ...
    object Network {
        val KTORFIT by lazy { "de.jensklingenberg.ktorfit:ktorfit-lib:${Version.Network.KTORFIT}" }
        val KTOR_FIT_KSP by lazy { "de.jensklingenberg.ktorfit:ktorfit-ksp:${Version.Network.KTORFIT}" }
        val KTOR_SERIALIZATION by lazy { "io.ktor:ktor-client-serialization:${Version.Network.KTOR}" }
        val KTOR_CLIENT_CONTENT_NEGOTATION by lazy { "io.ktor:ktor-client-content-negotiation:${Version.Network.KTOR}" }
        val KTOR_SERIALIZE_JSON by lazy { "io.ktor:ktor-serialization-kotlinx-json:${Version.Network.KTOR}" }
        val KTOR_CLIENT_SERIALIZE by lazy { "io.ktor:ktor-client-serialization:${Version.Network.KTOR}" }
...
object Module {
    ...
    val ROUTER by lazy { mapOf("path" to ":router") }
    val LOGIN by lazy { mapOf("path" to ":feature:login") }
    val NOTIFICATION by lazy { mapOf("path" to ":feature:notification") }
}